...
public class AllTestGeneratorService {
	...
	private void generateControllerTest(String baseDir, String className, EntityDefinition definition) {
		...
		imports.add(Utils.getTestPackage(rootDir + "/security/" + generatorProperties.getEntityPackage()) +
				".UserFixtures");
		imports.add(Utils.getTestPackage(rootDir + "/security/" + generatorProperties.getEntityPackage()) + ".User");
		imports.add(Utils.getTestPackage(rootDir + "/security/" + generatorProperties.getRepositoryPackage()) +
				".UserRepository");

		imports.add(Utils.getTestPackage(rootDir + "/tenant/" + generatorProperties.getEntityPackage()) + ".Tenant");

		imports.add(Utils.getTestPackage(rootDir + "/tenant/" + generatorProperties.getEntityPackage()) +
				".TenantFixtures");
		imports.add(Utils.getTestPackage(rootDir + "/tenant/" + generatorProperties.getRepositoryPackage()) +
				".TenantRepository");
