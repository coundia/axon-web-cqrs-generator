...
public class UsecaseGeneratorService {
	...
	public void generate(EntityDefinition definition, String baseDir) {
		...
		sharedTemplates.addAll(List.of(
				new SharedTemplate(
						...
						Set.of(
								...
								Utils.getPackage(outputShared + "/" + generatorProperties.getDtoPackage()) +
										".MetaRequest",
		...
		Set<String> importsGate = new HashSet<>(Set.of(
				...
				Utils.getPackage(Utils.getParent(baseDir) + "/tenant/" + generatorProperties.getEntityPackage()) +
						".Tenant",
				Utils.getPackage(Utils.getParent(baseDir) + "/security/" + generatorProperties.getServicePackage()) +
						".JwtService"
		...
		if (
			...
			importsGate.add(Utils.getPackage(baseDir + "/" + generatorProperties.getEntityPackage()) +
					"." +
