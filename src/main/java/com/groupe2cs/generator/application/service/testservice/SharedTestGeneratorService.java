	...
	private void generateBaseIntegrationTests(String baseDir, EntityDefinition definition) {
		...
		if (definition.isInStack("security")) {
			imports.add(Utils.getTestPackage(baseDir +
					"/" +
					generatorProperties.getSecurityPackage() +
					"/" +
					generatorProperties.getDtoPackage()) + ".*");
			imports.add(Utils.getTestPackage(baseDir +
					"/" +
					generatorProperties.getSecurityPackage() +
					"/" +
					generatorProperties.getEntityPackage()) + ".User");
			imports.add(Utils.getTestPackage(baseDir + "/tenant/" + generatorProperties.getEntityPackage()) +
					".Tenant");
		}
